...
export default function ProjectCard(){
    return(
        <div>
            ...
            <Button className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-m font-medium text-gray-600 dark:text-gray-400">React.js</Button>
            <Button className="px-3 py-1 bg-gray-100 dark:bg-gray-700 rounded-full text-m font-medium text-gray-600 dark:text-gray-400">Next.js</Button>
            </div>
            <div className="flex gap-5">
                <p className="text-m flex gap-1 items-center"><FaGithub className="w-5 h-5"/>Private Repository</p>
                <Link className="text-m flex gap-1 items-center" href={"https://circle-kappa-two.vercel.app/"}><FaExternalLinkAlt className="w-5 h-5"/>Live Demo</Link>
            </div>
            </div>
        </div>
    )
